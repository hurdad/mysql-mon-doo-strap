...
//Desktop Web Site
$route['get']['/'] = array('DesktopController', 'index');


//DB Stat Update CLI
$route['cli']['update_mysql_stats'] = array('DBStatsCLIUpdateController', 'mysql');

//DB stat AJAX Rest
$route['get']['/stats/mysql/questions'] = array('DBStatsRESTController', 'mysql_questions');
$route['get']['/stats/mysql/bytes'] = array('DBStatsRESTController', 'mysql_bytes');
$route['get']['/stats/mysql/connections'] = array('DBStatsRESTController', 'mysql_connections');
$route['get']['/stats/mysql/select_sort'] = array('DBStatsRESTController', 'mysql_select_sort');
$route['get']['/stats/mysql/table_locks'] = array('DBStatsRESTController', 'mysql_table_locks');
$route['get']['/stats/mysql/temp'] = array('DBStatsRESTController', 'mysql_temp');
$route['get']['/stats/mysql/innodb'] = array('DBStatsRESTController', 'mysql_innodb');
...
$route['*']['/tool'] = array('MainController', 'index');
